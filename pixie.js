...
function avatar(size, dark) {
  var s = size || 38;
  var A = dark ? '#e8873a' : '#fff';
  var B = dark ? '#d6a060' : '#ffd9b8';
  var C = dark ? '#12100e' : '#c25f1c';
...
function mount() {
  ...
  var tip = el('div', null, SHOP ? 'Si vous avez besoin d\'aide, je suis là 🙂' : 'Une question ? Je suis là 🙂');
