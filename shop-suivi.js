  ...
  const box = document.getElementById('ordersList');
    ...
    box.innerHTML = tabsHTML(orders) + `
      <div class="profile">
        ...
        <div style="margin-top:20px"><a href="#" style="color:var(--muted);font-size:12.5px;text-decoration:underline" onclick="setTab('orders');return false">&#8592; Retour à mes commandes</a></div>
